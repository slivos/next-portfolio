...
class MyDocument extends (next_document__WEBPACK_IMPORTED_MODULE_2___default()) {
  static async getInitialProps(ctx) {
    ...
    const initProps = await next_document__WEBPACK_IMPORTED_MODULE_2___default().getInitialProps(ctx);
